...
var storage = multer.diskStorage({ 
  ...
  filename: function(req, res, callback) {
    // callback(null, file.origilname + Date.now())
    var extension = path.extname(file.origilname)
    var basename = path.extname(file, origilname, extension)
...
router.route('/process/photo').post(uploade.array('photo', 1), function(req, res){
